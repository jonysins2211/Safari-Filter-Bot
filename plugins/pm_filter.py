    ...
    try:
        ...
        if not spoll:
            ...
            if len(message.text) < 100:
                search = message.text
                m=await message.reply_sticker(sticker="CAACAgIAAxkBAAIM-WhgWnYWoEzKyLMh_kYEQr162B_8AALmCgACFKMoSD95JviL1YpCNgQ",
                ...
                if not files:
                    ...
                    if settings["spell_check"]:
                        ai_sts = await message.reply_sticker(sticker=f"CAACAgIAAxkBAAIM-WhgWnYWoEzKyLMh_kYEQr162B_8AALmCgACFKMoSD95JviL1YpCNgQ")
